...
* At the top of the `lovelace-swipe-navigation.js` file there is a "config" section where you can play with some of the options (currently there is only one for swipe length).
